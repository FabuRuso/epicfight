...
public class ProviderEntity implements ICapabilityProvider {
	...
	public static void makeMap() {
		...
		try {
			Class<? extends Entity> gcPlayerMP = (Class<? extends Entity>)
					Class.forName("micdoodle8.mods.galacticraft.core.entities.player.GCEntityPlayerMP");
			capabilityMap.put(gcPlayerMP, ServerPlayerData::new);
	...
	public static void makeMapClient() {
		...
		try {
			Class<? extends Entity> gcPlayer = (Class<? extends Entity>)
					Class.forName("micdoodle8.mods.galacticraft.core.entities.player.GCEntityClientPlayerMP");
			capabilityMap.put(gcPlayer, ClientPlayerData::new);
		} catch (ClassNotFoundException e) { }
	}
