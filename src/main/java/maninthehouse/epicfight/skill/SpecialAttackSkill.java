...
public class SpecialAttackSkill extends Skill {
	...
	public List<ITextComponent> getTooltip() {
		...
		list.add(new TextComponentTranslation("skill." + EpicFightMod.MODID + "." + this.registryName.getPath())
				.appendSibling(new TextComponentString(TextFormatting.AQUA + String.format("[%.0f]", this.cooldown))));
		list.add(new TextComponentTranslation(TextFormatting.DARK_GRAY + "skill." + EpicFightMod.MODID + "." + this.registryName.getPath() + "_tooltip"));
